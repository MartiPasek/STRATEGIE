...
(function () {
  ...
  const COMP_PROP_CATALOG = [
    ...
    // Phase 38.4 Krok 10 (10.5.2026 vecer): cell_style + cell_renderer přes
    // pojmenované registry IDs (frontend CELL_STYLE_REGISTRY + CELL_RENDERER_REGISTRY).
    { prop_name: "cell_style", label: "Styl buňky", prop_type: "enum",
      basic: false, display_order: 210,
      options: [
        { v: "", t: "(none)" },
        { v: "mono", t: "Monospace" },
        { v: "mono_dim", t: "Monospace dim" },
        { v: "mono_small", t: "Monospace small" },
        { v: "mono_code", t: "Monospace code (SQL)" },
        { v: "dim_italic", t: "Dim italic" },
        { v: "weight_600", t: "Bold (600)" },
        { v: "status_active_disabled", t: "Status: active/disabled" },
        { v: "status_lifecycle", t: "Status: lifecycle (active/archived/draft/deprecated)" },
        { v: "status_confirmed_pending_revoked", t: "Status: confirmed/pending/revoked" },
        { v: "state_invite", t: "State: invite (consumed/expired/pending)" },
        { v: "result_security", t: "Result: security (success/failed/rate_limited)" },
        { v: "scope_global_user", t: "Scope: global/user" },
        { v: "kind_node", t: "Kind: menu node (folder/list/form)" },
        { v: "visibility_scope", t: "Visibility: scope (parent/admin/tenant/public)" },
        { v: "refresh_type", t: "Refresh: manual/auto/on_focus" },
        { v: "kind_data_set", t: "Kind: data_set (select/insert/update/delete)" },
        { v: "count_positive_green", t: "Count: positive green" },
        { v: "count_positive_dim", t: "Count: positive dim" },
        { v: "count_positive_yellow", t: "Count: positive yellow" },
        { v: "parent_code_dim", t: "Parent code dim" },
      ] },
    { prop_name: "cell_renderer", label: "Renderer buňky", prop_type: "enum",
      basic: false, display_order: 220,
      options: [
        { v: "", t: "(default text)" },
        { v: "yes_check", t: "Yes check (✓)" },
        { v: "lock_icon", t: "Lock icon (🔒)" },
        { v: "wrench_icon", t: "Wrench icon (🔧)" },
        { v: "thoughts_count", t: "Thoughts count (📝 N)" },
      ] },
    { prop_name: "default_sort", label: "Výchozí řazení", prop_type: "enum",
      basic: false, display_order: 230,
      options: [
        { v: "", t: "(none)" },
        { v: "asc", t: "Vzestupně" },
        { v: "desc", t: "Sestupně" },
