# CLAUDE.md — Archiv dodatků 1. 6. – 25. 6. 2026 (split 25. 6. + 8. 7. 2026)
...
## 📦 Split 8. 7. 2026 — dodatky 21. 6. – 25. 6. 2026 (přesunuto z CLAUDE.md)

Plný text dodatků 21.6.–25.6. (+ 21.6. noc generátor rozvrhu) přesunutých z CLAUDE.md 8. 7. 2026 (krabička znovu přerostla limit 150k znaků). Nic není zkráceno.
