...
| `docs/ISO27001/Registr_rizik_pracovni.xlsx` | **Předdraft registru rizik (DOC-05)** — 22 rizik se skórováním (D×P→úroveň), stávající opatření, ošetření, vlastník, vazba Annex A; souhrn. Startovní bod pro Kristý (A.6.1.2) |
