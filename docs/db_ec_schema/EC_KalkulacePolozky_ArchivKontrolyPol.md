# EC_KalkulacePolozky_ArchivKontrolyPol

**Schema**: dbo · **Cluster**: Production · **Rows**: 687 · **Size**: 1.25 MB · **Sloupců**: 113 · **FK**: 0 · **Indexů**: 0
...
| 111 | `DatumZalozeni` | datetime | ANO |  |  |
| 112 | `Zalozil` | nvarchar(10) | ANO |  |  |
| 113 | `ID_VPoptavky` | int | ANO |  |  |
