# EC_Ukoly_Komplet_Income

**Schema**: dbo · **Cluster**: Other · **Rows**: 0 · **Size**: 0.00 MB · **Sloupců**: 70 · **FK**: 0 · **Indexů**: 1
...
| 1 | `ID` | int | NE |  |  |
| 2 | `IDUkol` | int | ANO |  |  |
| 3 | `IDUkol_New` | int | ANO |  | ID vytvoreneho ukolu v ostre databazi |
...
| 11 | `Popis` | ntext | ANO |  |  |
| 12 | `TerminZahajeni` | datetime | ANO | (getdate()) |  |
| 13 | `TerminSplneni` | datetime | ANO | (getdate()+(1)) |  |
| 14 | `OdhadHod` | numeric(19,2) | ANO | ((0.5)) |  |
| 15 | `Neverejny` | bit | ANO | ((0)) |  |
| 16 | `Aktivni` | bit | ANO | ((0)) |  |
...
| 24 | `InfoProZadavatele` | bit | ANO | ((0)) |  |
| 25 | `InfoProResitele` | bit | ANO | ((0)) |  |
| 26 | `ZadavatelChceInfo` | bit | ANO | ((0)) |  |
...
| 33 | `DatPorizeni` | datetime | ANO | (getdate()) |  |
...
| 69 | `ZaznamVlozil` | nvarchar(50) | ANO | (suser_sname()) |  |
| 70 | `IDObjMat` | int | ANO |  |  |

## Indexy

- **PK** `PK_EC_Ukoly_Komplet_Income` (CLUSTERED) — `ID`
