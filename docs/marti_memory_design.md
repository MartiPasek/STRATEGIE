...
3. **Fáze 3:** Certainty scoring + auto-promoce nad threshold. User trust rating. Rodičovská role (cross-tenant viditelnost). — **CODE COMPLETE 2026-04-22**, čeká review + commit.
