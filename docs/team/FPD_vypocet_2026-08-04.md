# FPD — jak se počítá a co se má proplatit

**Peťa + Claude‑26, 4. 8. 2026, ověřeno na datech července 2026.**

> ⚠️ **Tohle je záložní kopie na disku.** Zápis do G2007 pod kódem
> `doc-dochazka-fpd-vypocet-kancelar-vs-dilna` **neprošel** — most byl 4. 8. od 17:44
> odhlášený (HTTP 401) a pět pokusů mezi 17:58 a 18:02 selhalo. **Až most pojede,
> zapsat do G2007 a tenhle soubor pak může zmizet.**
...
U Horkého to dělalo **185,13 h místo správných ~176 h**.

## Kdo je „kancelář"

Automat dopichuje jen lidem v kategorii s příznakem `dopichavat_fond`. Prakticky =
kdo má v měsíci záznamy **„Doplnění do fondu (automat)"** nebo **„Nenároková práce
(nad fond)"**. Karta zaměstnance to **nerozlišuje** — dílenští i kancelářští tam mají
stejné hodnoty.
