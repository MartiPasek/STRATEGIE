...
- Nástrojů: **170** → [nastroje/_prehled.md](nastroje/_prehled.md)
- Kufrů: **5** → `kufry/`
- Entit: **5** → `entity/`
- Grafů: **2** → `grafy/`
- Snímků struktury: **1** → `struktura/`
- Znalostí: **682** v **15** oblastech → [znalosti/_prehled.md](znalosti/_prehled.md)
...
Oblasti (kód): `system-g2007`, `marti-ai`, `system-strategie`, `provoz`, `ucetnictvi`, `vyroba`, `mzdy`, `dochazka`, `projekty`, `nabidky`, `kalkulace-rozvadecu`, `bozp-po`, `tisax`, `iso27001`, `osoba`.
