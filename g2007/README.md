...
- Znalostí: **121** v **12** oblastech → [znalosti/_prehled.md](znalosti/_prehled.md)
...
Oblasti (kód): `system-g2007`, `marti-ai`, `ucetnictvi`, `mzdy`, `dochazka`, `projekty`, `nabidky`, `kalkulace-rozvadecu`, `bozp-po`, `tisax`, `iso27001`, `osoba`.
