...
| `system-strategie` | system | 245 | Technicka a provozni znalostni baze platformy STRATEGIE — DB architektura, produkcni infrastruktura, architektonicke principy, dev workflow. Presunuto z CLAUDE.md (C27, 21.7.2026), aby MD drzela jen osobni/vztahove jadro. |
| `provoz` | system | 13 | Operacni znalost - mostni kanaly, lekce, schemata DB. Aby to bylo dohledatelne. |
| `ucetnictvi` | obor | 16 | Oborova znalost pro personu ucetni. |
| `vyroba` |  | 41 |  |
| `mzdy` | obor | 65 | Oborova znalost pro personu mzdovou. |
| `dochazka` | obor | 226 | Oborova znalost pro personu odpovednou za dochazku. |
