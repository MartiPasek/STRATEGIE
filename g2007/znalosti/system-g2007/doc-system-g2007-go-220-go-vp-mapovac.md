...
Jak AI řídí oddělení Vedení projektů (VP). Grounded na `doc-system-g2007-vp-ai-rizeni-vize` a na prvním reálném zmapování (18. 7.). **Toto je trvalý vzor — NE denní stav** (ten je efemérní, patří do denní vrstvy).
...
Proč to takhle: **jeden zdroj pravdy na den** (agenti se nerozcházejí), **levné na cache** (denní bake, dok 200 — upeč ráno, drží celý den), **auditovatelné** (ráno vidíš, z čeho se vychází). Je to ta obrácená smyčka z `doc-system-g2007-vp-ai-rizeni-vize`: AI drží world-model, lidé z něj jednají.
