...
## Co z puvodniho zjisteni zustava platne

`_syncNavH` funguje a reakce na `resize` funguje - to bylo overeno. **Jestli je observer v poradku,
nebo ne, NEVIME** a netvrdime to. Doměří se to na vytazenem okne.
