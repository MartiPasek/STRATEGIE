...
- api.eurosoft.com -> /marti-mcp/ -> localhost port 8765 (MCP), /ondra-mcp/ -> 8766 -- POZOR, MRTVE PRAVIDLO. Overeno 8. 9. 2026 primo na EC-SERVER2 (netstat): na portu 8766 NEPOSLOUCHA NIC (jediny nalez byl UDP 58766, jiny port) a ze sluzeb tam bezi jen EUROSOFT-MCP. Kdo na tu adresu posle pozadavek, nedostane odpoved - stejny druh pasti jako neexistujici lane 4 mostu. Zvazit zruseni pravidla.
- PATICKA VERZI (8002 vs 8003) uz nelze. Do 8. 9. 2026 cetla zmrazeny zaznam z fw.api_version, ktery se u zalohy aktualizuje jen tim, ze si nekdo otevre stranku stavu - vypadalo to, ze zaloha stoji na starsim kodu, a kdo by se pri spatnem nasazeni prepnul, dostal by tentyz kod. Od commitu ff4a0c97 se seznam verzi pta bezici instance primo (/api-info po localhostu, kratka pamet 30 s) a popisek rika pravdu - "Zaloha - stejny kod jako aktualni", "Zaloha - starsi kod", nebo "Zaloha - neodpovida". Odezva merena po nasazeni 21-50 ms.
