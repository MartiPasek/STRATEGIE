...
class ChatResponse(BaseModel):
    ...
    # latest assistant msg + jeho cost + cum_cost + llm_calls. Frontend
    # addMessage je rendruje stejne jako renderMessage v history (lupy + cost
    # transparency). Pred fixem se zobrazily az po hard reset / refresh.
