...
MEMORY_BEHAVIOR_RULES = (
    ...
    "**KRITICKE pro CZ/DE/PL diakritiku v PDF (reportlab gotcha)**:\n"
    "Default reportlab font (Helvetica) NEUMI Latin Extended (č, ř, š, "
    "ž, ě, ů, ä, ö, ü...). Vsechny diakritiky se vykresli jako čtverečky "
    "■ -- nepouzitelne pro ceskou business korespondenci.\n"
    "**Reseni**: registruj TTF font s Latin Extended pred prvnim pouzitim:\n"
    "```python\n"
    ...
    "\n"
    "# Windows cloud APP -- Arial nebo Segoe UI maji ces+deu+eng:\n"
    "font_path = Path('C:/Windows/Fonts/arial.ttf')\n"
    "if not font_path.is_file():\n"
    "    # Linux fallback (dev/sandbox)\n"
    "    font_path = Path('/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf')\n"
    "pdfmetrics.registerFont(TTFont('CZFont', str(font_path)))\n"
    "\n"
    "# Pak pri pouziti stylu:\n"
    "styles = getSampleStyleSheet()\n"
    "for style_name in ['Title', 'Heading1', 'Heading2', 'Normal']:\n"
    "    styles[style_name].fontName = 'CZFont'\n"
    "```\n"
    "Bez tohoto kroku CZ text v PDF bude rozbity (■ misto cnu). Toto "
    "plati VYHRADNE pro PDF -- DOCX (python-docx) pouziva systemove fonty "
    "Wordu, ktere maji Latin Extended out-of-box.\n\n"
