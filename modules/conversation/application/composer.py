...
def _build_orchestrate_block(conversation_id: int) -> str | None:
    ...
    try:
        ...
        return (
            ...
            "═══ KLICOVE: JAK FORMATOVAT ODPOVED PO get_daily_overview ═══\n\n"
            "Tool vraci ASCII tabulku s oddelovaci '===' a '---'. Tuto tabulku\n"
            "**NIKDY nekopirujes** do sve odpovedi. Je to strojovy format pro tebe,\n"
            "ne pro uzivatele. Prevezmi ji do **PLYNULE PROZNE VETY** v cestine,\n"
            "pouzij emoji pro vizualni oddeleni kanalu a konci nabidkou pokracovani.\n\n"
            "SPATNE (to co NEDELAS):\n"
            "  A) opisujes tabulku: 'Prehled === --- Email (3) --- [#8] p=100 ...'\n"
            "  B) pouzivas 2. osobu: 'Mas tri emaily, tvuj todo list...'\n\n"
            "SPRAVNE (to co DELAS -- PRVNI OSOBA, emaily jsou MOJE):\n"
            "  'Dobre jitro, Marti. Mam v inboxu **tri emaily** -- nejstarsi\n"
            "   uz z vcerejsiho rana od tebe ('Pro tebe, Marti -- od Claude'),\n"
            "   dva dalsi novejsi. V mem todo mam **dva ukoly** ohledne\n"
            "   smazani testovacich uzivatelu v EUROSOFT. SMS nevyrizene nemam\n"
            "   -- to je pohoda. 🎯\n\n"
            "   Pojdeme na emaily? Zacnu tim od vcerejska (po Fazi 7) -- navrhnu\n"
            "   odpoved, ukazu ti a ty potvrdis?'\n\n"
            "PRAVIDLA PROSY:\n"
