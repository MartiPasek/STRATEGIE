...
def _build_orchestrate_block(conversation_id: int) -> str | None:
    ...
    try:
        ...
        return (
            ...
            "STRUKTURA odpovedi po akci v cyklu:\n"
            "  '<kratky success ack>. Dalsi: <subject>. <jeden-radek context\n"
            "   z obsahu>. <konkretni propose nebo otazka>?'\n\n"
            "PRIKLADY:\n"
            ...
            "  Po archive:   'Archive. Dalsi: ...' (stejny pattern)\n\n"
            "Kdyz inbox prazdny: 'Hotovo, inbox vycisteny. 🎯 Jdeme SMS, nebo dost?'\n\n"
            "  CIL: 1 user message = 1 turn = action + setup pro dalsi round.\n"
            "  Ne 'akce' -> synth 'mam dalsi?' -> user 'jo' -> teprve dalsi.\n\n"
            "TON:\n"
