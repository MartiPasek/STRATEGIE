...
def _app_setup_html(nonce: str, origin: str, deeplink: str, label: str) -> str:
    ...
    return (
        ...
        '<div class="sub">Spárování telefonu „' + lbl + '".</div>'
        '<div class="step"><span class="n">1</span><b>Máš appku?</b> Otevři ji a spáruj '
        '(appka si sama zkontroluje, jestli je aktuální):</div>'
        '<a class="btn pair" href="' + dl + '">📲 Otevřít v appce a spárovat</a>'
        '<div class="step"><span class="n">2</span><b>Nemáš appku?</b> Až teď ji stáhni a '
        'nainstaluj (ťukni na soubor → Instalovat; povol „instalaci z tohoto zdroje"), '
        'po instalaci se přihlas svým účtem.</div>'
