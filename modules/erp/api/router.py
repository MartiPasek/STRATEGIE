...
# ─────────────────────────────────────────────────────────────────────
# Phase SYSTEM NEW (21.5.2026): /system/security handler dropped.
# 5 modes (devices/users/whitelists/auth_audit/invites/audit) migrated
# to FW chain: fw.menu_node 'system_new.security.*' + fw.data_source
# + fw.data_set with SELECT * pattern (Marti's MVP doctrine 21.5.).
# 296 lines dropped. ORM models (TrustedDevice, GlobalIpWhitelist,
# UserIpWhitelist, TrustedDeviceInvite, AuthAudit) zustavaji v
# models_data.py — pouzivaji se v Phase 38 auth flow.
# ─────────────────────────────────────────────────────────────────────
