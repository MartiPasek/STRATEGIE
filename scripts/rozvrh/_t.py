...
for tr in ["2E","2A","25","1U"]:
    print(tr,_lbl(tr),"Písmo a typografie ->",room_doc(tr,"Písmo a typografie"),"| Písmo ->",room_doc(tr,"Písmo"))
# kolik units má naz obsahující písmo a jaké rms
for u in units:
    if "ísmo" in u["pnaz"]:
        print("UNIT",u["trid"],_lbl(u["trid"]),repr(u["pnaz"]),"rooms=",u["rooms"],"L",u["L"])
