...
def subkeys(u):
    ...
    return [(t,u["skup"])]
TLIMIT={"UTS88":4,"UXS9D":3,"UOS6U":4,"UZS4O":4,"UOS6X":3,"UVS8S":2}
def solve(group,tbusy,rbusy,tsec,tdays_prior):
    ...
    terms=[]
    for ui,u in enumerate(group):
        w=1000+8*u["L"]+(250 if any(t in WATCH for t in u["teachers"]) else 0)+(700 if "UNS6G" in u["teachers"] else 0)+rr.randint(0,7)
