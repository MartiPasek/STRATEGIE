...
import os as _os
_hint=None
if _os.path.exists("gen_odb_hint.json"):
    _h=json.load(open("gen_odb_hint.json"))
    if isinstance(_h,list) and len(_h)==len(units): _hint=_h
print("hint:","ano" if _hint else "ne")
o,un,assign=solve(units,set(tbusy0),set(rbusy0),SEC,{},hint=_hint)
